...
abstract class BaseTelefoneForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tipo_telefone_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TipoTelefone'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'tipo_telefone_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TipoTelefone'))),
      'ddd'              => new sfValidatorString(array('max_length' => 2)),
      'numero'           => new sfValidatorString(array('max_length' => 9)),
